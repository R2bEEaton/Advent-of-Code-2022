...
Here's a version of Part 1 with sets, akin to below that I thought of after doing Part 2. It seems this year's theme is set theory. Days 1, 3, and now 4 have applications with set theory.
```python
a = range(aa, ab+1)
b = range(ba, bb+1)
